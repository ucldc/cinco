...
from cincoctrl.findingaids.forms import FileForm
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return HttpResponseRedirect(
                reverse(
                    "findingaids:list_records",
                    kwargs={"repository_id": repo.pk, "record_type": "ead"},
                ),
            )
    else:
        form = FileForm()
        ...
        if form.is_valid():
            ...
            return HttpResponseRedirect(
                reverse(
                    "findingaids:list_records",
                    kwargs={
                        "repository_id": record.repository.pk,
                        "record_type": "ead",
                    },
                ),
            )
